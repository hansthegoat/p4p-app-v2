...
import { u as useTheme, a as useP4P, b as useUser, s as supabase, g as getCurrentUser } from "./router-w7c543WJ.js";
import { ChevronRight, Check, Circle, Sun, Moon, Monitor, Bell, Loader2, CheckCheck, AlertOctagon, AlertTriangle, MessageSquare, RefreshCw, XCircle, CheckCircle2, ClipboardCheck, LogOut, X, Clock, LayoutDashboard, Target, Calculator, Users, FileSpreadsheet, TrendingUp, FileText, History, UserCheck, KeyRound, Menu, Sparkles } from "lucide-react";
import { B as Button } from "./button-D-QX7IMW.js";
import * as DropdownMenuPrimitive from "@radix-ui/react-dropdown-menu";
import { c as cn, C as Card } from "./card-DJtmP4ah.js";
import { d as dropdown, p as pageTransition } from "./motion-BS01Szpl.js";
    ...
    /* @__PURE__ */ jsx(
      motion.div,
      {
        ...
        children: /* @__PURE__ */ jsxs(Card, { className: "p-6 shadow-2xl", children: [
          /* @__PURE__ */ jsxs("div", { className: "flex items-start justify-between mb-4", children: [
            /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-3", children: [
              ...
              /* @__PURE__ */ jsxs("div", { children: [
                ...
                /* @__PURE__ */ jsx("p", { className: "text-xs text-muted-foreground mt-0.5", children: "You'll need to sign in again." })
              ] })
            ] }),
            /* @__PURE__ */ jsx(
              "button",
          ...
          /* @__PURE__ */ jsx("div", { className: "rounded-lg bg-muted/40 border border-border/60 p-3 mb-4", children: /* @__PURE__ */ jsx("p", { className: "text-xs text-muted-foreground leading-relaxed", children: "Any unsaved changes will be lost. Make sure you've saved your work before logging out." }) }),
...
function SessionTimeoutWarning({ open, secondsLeft, onStay, onLogout }) {
  if (!open) return null;
  const mins = Math.floor(secondsLeft / 60);
  const secs = secondsLeft % 60;
  const label = `${mins}:${secs.toString().padStart(2, "0")}`;
  return /* @__PURE__ */ jsx("div", { className: "fixed inset-0 z-[100] flex items-center justify-center bg-black/60 backdrop-blur-sm p-4", children: /* @__PURE__ */ jsxs("div", { className: "bg-background border border-border rounded-lg shadow-2xl max-w-sm w-full p-6 text-center", children: [
    /* @__PURE__ */ jsx("div", { className: "w-12 h-12 rounded-full bg-amber-500/10 border border-amber-500/30 flex items-center justify-center mx-auto mb-4", children: /* @__PURE__ */ jsx(Clock, { className: "h-5 w-5 text-amber-600 dark:text-amber-400" }) }),
    /* @__PURE__ */ jsx("h2", { className: "text-base font-semibold mb-1", children: "Session expiring" }),
    /* @__PURE__ */ jsxs("p", { className: "text-[13px] text-muted-foreground mb-4", children: [
      "You've been inactive. Signing out in",
      " ",
      /* @__PURE__ */ jsx("span", { className: "font-semibold text-foreground tabular-nums", children: label }),
      "."
    ] }),
    /* @__PURE__ */ jsxs("div", { className: "flex gap-2", children: [
      /* @__PURE__ */ jsx(Button, { variant: "outline", size: "sm", onClick: onLogout, className: "flex-1", children: "Sign out now" }),
      /* @__PURE__ */ jsx(
        Button,
        {
          size: "sm",
...
const WARNING_BEFORE_MS = 2 * 60 * 1e3;
...
function useSessionTimeout(onTimeout) {
  ...
  const [secondsLeft, setSecondsLeft] = useState(Math.round(WARNING_BEFORE_MS / 1e3));
  ...
  const scheduleTimers = () => {
    ...
    warningTimerRef.current = window.setTimeout(() => {
      ...
      setShowWarning(true);
      setSecondsLeft(Math.round(WARNING_BEFORE_MS / 1e3));
  ...
  useEffect(() => {
    ...
    ACTIVITY_EVENTS.forEach(
      (ev) => window.addEventListener(ev, handleActivity, { passive: true })
    );
    scheduleTimers();
    return () => {
      ACTIVITY_EVENTS.forEach(
        (ev) => window.removeEventListener(ev, handleActivity)
      );
      clearAll();
    };
  }, []);
  ...
  const renderNavLink = (item, onClick) => {
    ...
    return /* @__PURE__ */ jsxs(
      Link,
      {
        to: item.to,
        onClick,
        className: `relative flex items-center gap-3 px-3 py-2 rounded-md text-sm font-medium transition-colors ${active ? "text-primary-foreground" : "text-foreground hover:bg-accent hover:text-accent-foreground"}`,
        children: [
          active && /* @__PURE__ */ jsx(
            motion.div,
            {
          ...
          /* @__PURE__ */ jsx(Icon, { className: "h-4 w-4 shrink-0 relative z-10" }),
          /* @__PURE__ */ jsx("span", { className: "truncate relative z-10", children: item.label }),
          showBadge && /* @__PURE__ */ jsx("span", { className: "relative z-10 ml-auto bg-amber-500 text-white text-[10px] font-bold rounded-full min-w-[18px] h-[18px] flex items-center justify-center px-1.5", children: pendingKpiUpdates })
        ]
      },
      item.to
    );
  ...
  return /* @__PURE__ */ jsxs("div", { className: "min-h-screen bg-background", children: [
    ...
    /* @__PURE__ */ jsxs("div", { className: "flex items-start", children: [
      ...
      mobileMenuOpen && /* @__PURE__ */ jsxs(Fragment, { children: [
        ...
        /* @__PURE__ */ jsx("aside", { className: "fixed top-14 left-0 bottom-0 w-[min(16rem,calc(100vw-1rem))] border-r bg-background z-40 overflow-y-auto lg:hidden", children: /* @__PURE__ */ jsx("nav", { className: "flex-1 p-3 space-y-1", children: visibleItems.map(
