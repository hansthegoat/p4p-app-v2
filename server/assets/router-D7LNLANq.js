...
const appCss = "/p4p-app-v2/assets/styles-Br3MYfSy.css";
...
function P4PProvider({ children }) {
  ...
  const setBonusRevealed = useCallback(async (value2) => {
...
function SplashScreen() {
  ...
  const logoSrc = `${"/p4p-app-v2/"}logo.png`;
  return /* @__PURE__ */ jsx(
    "div",
    {
      ...
      children: /* @__PURE__ */ jsxs("div", { className: "relative z-10 flex flex-col items-center", children: [
        /* @__PURE__ */ jsxs("div", { className: "relative flex items-center justify-center w-[28rem] h-[28rem] sm:w-[32rem] sm:h-[32rem]", children: [
          /* @__PURE__ */ jsxs(
            "svg",
            {
              ...
              viewBox: "0 0 200 200",
              children: [
                /* @__PURE__ */ jsx("defs", { children: /* @__PURE__ */ jsxs("linearGradient", { id: "sweepNavy", x1: "0%", y1: "0%", x2: "100%", y2: "100%", children: [
                  /* @__PURE__ */ jsx("stop", { offset: "0%", stopColor: "#0B2545", stopOpacity: "0" }),
                  /* @__PURE__ */ jsx("stop", { offset: "60%", stopColor: "#0B2545", stopOpacity: "0.6" }),
                  /* @__PURE__ */ jsx("stop", { offset: "100%", stopColor: "#0B2545", stopOpacity: "0.95" })
                ] }) }),
                /* @__PURE__ */ jsx(
                  "circle",
                  {
        ...
        /* @__PURE__ */ jsx("div", { className: "h-6 mt-4 flex items-center justify-center overflow-hidden", children: /* @__PURE__ */ jsx(
          "p",
          {
            className: "text-[13px] tracking-wide animate-[splashFade_0.4s_ease-out_forwards]",
            style: { color: "#0B2545", opacity: 0.65 },
            children: STATUS_MESSAGES[messageIndex]
          },
          messageIndex
        ) })
      ] })
...
function RootComponent() {
  ...
  return /* @__PURE__ */ jsx(QueryClientProvider, { client: queryClient, children: /* @__PURE__ */ jsx(ThemeProvider, { defaultTheme: "light", storageKey: "p4p-theme", children: /* @__PURE__ */ jsx(P4PProvider, { children: /* @__PURE__ */ jsxs(UserProvider, { children: [
...
const $$splitComponentImporter$l = () => import("./verify-otp-CK3NOMfu.js");
const Route$m = createFileRoute("/verify-otp")({
  component: lazyRouteComponent($$splitComponentImporter$l, "component")
});
const $$splitComponentImporter$k = () => import("./reset-password-DJ4ZrEhV.js");
const Route$l = createFileRoute("/reset-password")({
  component: lazyRouteComponent($$splitComponentImporter$k, "component")
});
const $$splitComponentImporter$j = () => import("./forgot-password-Bk9MvYRz.js");
const Route$k = createFileRoute("/forgot-password")({
  component: lazyRouteComponent($$splitComponentImporter$j, "component")
});
const $$splitComponentImporter$i = () => import("./_app-QWUzmtIY.js");
...
const $$splitComponentImporter$h = () => import("./route-C0IkNO0m.js");
...
const $$splitComponentImporter$g = () => import("./register-DrtRUfdI.js");
...
const $$splitComponentImporter$f = () => import("./login-DwtoLxnR.js");
const Route$f = createFileRoute("/_auth/login")({
  component: lazyRouteComponent($$splitComponentImporter$f, "component")
});
const $$splitComponentImporter$e = () => import("./_app.trace-DpRWsSyd.js");
const Route$e = createFileRoute("/_app/trace")({
  component: lazyRouteComponent($$splitComponentImporter$e, "component")
});
const $$splitComponentImporter$d = () => import("./_app.supervisors-DEGd_bN0.js");
const Route$d = createFileRoute("/_app/supervisors")({
  component: lazyRouteComponent($$splitComponentImporter$d, "component")
});
const $$splitComponentImporter$c = () => import("./_app.profile-CPOSSckJ.js");
const Route$c = createFileRoute("/_app/profile")({
  component: lazyRouteComponent($$splitComponentImporter$c, "component")
});
const $$splitComponentImporter$b = () => import("./_app.my-calculation-DG4mH-oc.js");
const Route$b = createFileRoute("/_app/my-calculation")({
  component: lazyRouteComponent($$splitComponentImporter$b, "component")
});
const $$splitComponentImporter$a = () => import("./_app.monthly-Bv-Isgtb.js");
const Route$a = createFileRoute("/_app/monthly")({
  component: lazyRouteComponent($$splitComponentImporter$a, "component")
});
const $$splitComponentImporter$9 = () => import("./_app.kpi-updates-B64ln9T_.js");
const Route$9 = createFileRoute("/_app/kpi-updates")({
  component: lazyRouteComponent($$splitComponentImporter$9, "component")
});
const $$splitComponentImporter$8 = () => import("./_app.kpi-framework-B6hj1pxz.js");
const Route$8 = createFileRoute("/_app/kpi-framework")({
  component: lazyRouteComponent($$splitComponentImporter$8, "component")
});
const $$splitComponentImporter$7 = () => import("./_app.grades-0MSsBMAL.js");
const Route$7 = createFileRoute("/_app/grades")({
  component: lazyRouteComponent($$splitComponentImporter$7, "component")
});
const $$splitComponentImporter$6 = () => import("./_app.employees-1GxrQkdh.js");
const Route$6 = createFileRoute("/_app/employees")({
  component: lazyRouteComponent($$splitComponentImporter$6, "component")
});
const $$splitComponentImporter$5 = () => import("./_app.employee-DAhhrOfY.js");
const Route$5 = createFileRoute("/_app/employee")({
  component: lazyRouteComponent($$splitComponentImporter$5, "component")
});
const $$splitComponentImporter$4 = () => import("./_app.dashboard-CpKZaowA.js");
const Route$4 = createFileRoute("/_app/dashboard")({
  component: lazyRouteComponent($$splitComponentImporter$4, "component")
});
const $$splitComponentImporter$3 = () => import("./_app.change-password-9KoFRNTo.js");
const Route$3 = createFileRoute("/_app/change-password")({
  component: lazyRouteComponent($$splitComponentImporter$3, "component")
});
const $$splitComponentImporter$2 = () => import("./_app.audit-log-okrqfUOR.js");
const Route$2 = createFileRoute("/_app/audit-log")({
  component: lazyRouteComponent($$splitComponentImporter$2, "component")
});
const $$splitComponentImporter$1 = () => import("./_app.appraisals-review-BdeMwUR3.js");
const Route$1 = createFileRoute("/_app/appraisals-review")({
  component: lazyRouteComponent($$splitComponentImporter$1, "component")
});
const $$splitComponentImporter = () => import("./_app.appraisals-DqsUtIiy.js");
