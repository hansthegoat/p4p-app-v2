...
import { a as useP4P, c as fmtNum, g as getCurrentUser, d as uploadProofFile } from "./router-w7c543WJ.js";
...
import { T as Tabs, a as TabsList, b as TabsTrigger } from "./tabs-Bh6hTGzN.js";
...
import { AlertCircle, Target, Sparkles, Clock, Mail, FileSpreadsheet, CheckCircle, Send, Info, Calendar, BarChart3, Award, Activity, PieChart, Users, Paperclip, MessageSquare, Upload, ChevronRight, File, X, Star, TrendingUp } from "lucide-react";
...
function EmployeePortal() {
  ...
  return /* @__PURE__ */ jsxs(motion.div, { initial: "hidden", animate: "show", variants: staggerContainer, className: "space-y-6", children: [
    /* @__PURE__ */ jsx(PageHeader, { title: "My KPIs", description: `${employee.name} · ${employee.department} · ${employee.role}`, icon: /* @__PURE__ */ jsx(Target, { className: "h-6 w-6" }), actions: !hasNoKpis ? /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-3", children: [
    ...
    hasNoKpis ? /* @__PURE__ */ jsxs(Fragment, { children: [
      /* @__PURE__ */ jsx(motion.div, { variants: fadeUp, children: /* @__PURE__ */ jsxs(Card, { className: "p-8 bg-gradient-to-br from-amber-500/5 via-background to-background border-amber-500/20 overflow-hidden relative", children: [
        /* @__PURE__ */ jsx("div", { className: "absolute -top-16 -right-16 w-64 h-64 rounded-full bg-amber-500/10 blur-3xl" }),
        /* @__PURE__ */ jsxs("div", { className: "relative text-center max-w-2xl mx-auto", children: [
          /* @__PURE__ */ jsx("div", { className: "w-16 h-16 rounded-2xl bg-amber-500/10 border border-amber-500/30 flex items-center justify-center mx-auto mb-4", children: /* @__PURE__ */ jsx(Sparkles, { className: "h-8 w-8 text-amber-600 dark:text-amber-400" }) }),
          /* @__PURE__ */ jsx("h2", { className: "text-2xl font-bold mb-2", children: "Your KPIs Are Being Set Up" }),
          /* @__PURE__ */ jsxs("p", { className: "text-sm text-muted-foreground mb-4 leading-relaxed", children: [
            ...
            " ",
            /* @__PURE__ */ jsx("strong", { className: "text-foreground", children: employee.department }),
            " ·",
            " ",
            /* @__PURE__ */ jsx("strong", { className: "text-foreground", children: employee.role }),
            ".",
            /* @__PURE__ */ jsx("br", {}),
            "Your KPIs will appear here once they're assigned — usually within 1–2 business days."
          ] }),
          /* @__PURE__ */ jsxs("div", { className: "inline-flex items-center gap-2 px-4 py-2 rounded-full bg-muted text-xs text-muted-foreground", children: [
            /* @__PURE__ */ jsx(Clock, { className: "h-3.5 w-3.5" }),
            "Waiting for template assignment"
          ] })
        ] })
      ] }) }),
      /* @__PURE__ */ jsx(motion.div, { variants: fadeUp, children: /* @__PURE__ */ jsx(SectionCard, { title: "What Happens Next?", description: "Steps to activate your KPI dashboard", icon: /* @__PURE__ */ jsx(Info, { className: "h-4 w-4" }), children: /* @__PURE__ */ jsx("div", { className: "space-y-3", children: [{
        icon: Mail,
        title: "HR notified",
        desc: "HR/Admin has been notified that you need KPIs."
      }, {
        icon: FileSpreadsheet,
        title: "Template created",
        desc: "HR will set up a KPI template for your department and role."
      }, {
        icon: CheckCircle,
        title: "KPIs assigned",
        desc: "Your KPI dashboard will activate automatically."
      }, {
        icon: Send,
        title: "You can submit",
        desc: "Once KPIs appear, you can start entering data and submitting for review."
      }].map((step, i) => {
        const Icon = step.icon;
        return /* @__PURE__ */ jsxs("div", { className: "flex items-start gap-3 p-3 rounded-lg bg-muted/30 border border-border/60", children: [
          /* @__PURE__ */ jsx("div", { className: "w-8 h-8 rounded-lg bg-primary/10 text-primary flex items-center justify-center shrink-0", children: /* @__PURE__ */ jsx(Icon, { className: "h-4 w-4" }) }),
          /* @__PURE__ */ jsxs("div", { className: "flex-1", children: [
            ...
            /* @__PURE__ */ jsx("p", { className: "text-xs text-muted-foreground mt-0.5", children: step.desc })
          ] })
        ] }, i);
      }) }) }) })
      ...
      /* @__PURE__ */ jsx(motion.div, { variants: fadeUp, children: /* @__PURE__ */ jsxs(Card, { className: `p-4 flex items-start gap-3 ${hasApprovedData ? "bg-emerald-500/5 border-emerald-500/20" : "bg-blue-500/5 border-blue-500/20"}`, children: [
        ...
        /* @__PURE__ */ jsx("p", { className: `text-xs leading-relaxed ${hasApprovedData ? "text-emerald-800 dark:text-emerald-300" : "text-blue-800 dark:text-blue-300"}`, children: hasApprovedData ? "This period has approved data. You can edit and resubmit — new approval will replace the old data." : "Enter your actuals, add comments, and upload support files. Click Submit for Appraisal when ready." })
      ] }) }),
              ...
              /* @__PURE__ */ jsxs("div", { className: "grid grid-cols-12 gap-3 items-start", children: [
                ...
                /* @__PURE__ */ jsxs("div", { className: "col-span-12 sm:col-span-2 flex items-center justify-end gap-1.5", children: [
                  ...
                  /* @__PURE__ */ jsxs(Button, { size: "sm", variant: "outline", className: "h-8 gap-1.5 text-xs", onClick: () => fileInputRefs.current[kpi.id]?.click(), disabled: isUploading, children: [
                    ...
                    /* @__PURE__ */ jsx("span", { className: "hidden sm:inline", children: "Support File" })
                  ] }),
