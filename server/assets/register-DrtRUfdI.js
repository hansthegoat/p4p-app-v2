...
import { P as P4PProvider, a as useP4P, s as supabase } from "./router-D7LNLANq.js";
import { getDepartments, getRolesForDepartment } from "./kpi-templates-Dent6LXX.js";
...
function RegisterForm() {
  ...
  return /* @__PURE__ */ jsxs(Card, { className: "p-6", children: [
    ...
    /* @__PURE__ */ jsxs("form", { onSubmit: handleSubmit, className: "space-y-4", children: [
      ...
      /* @__PURE__ */ jsx(Button, { type: "submit", className: "w-full", disabled: loading || !department || !role || !pwCheck.ok, children: loading ? "Creating Account..." : "Register" })
    ] })
  ] });
}
