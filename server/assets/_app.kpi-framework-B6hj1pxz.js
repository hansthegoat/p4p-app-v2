...
import { n as newId, a as useP4P } from "./router-D7LNLANq.js";
...
import { getRolesForDepartment, getTemplateByDepartmentAndRole, getDepartments } from "./kpi-templates-Dent6LXX.js";
import "@sentry/react";
...
function exportAllTemplatesToExcel(templates) {
  ...
  XLSX.writeFile(wb, `P4P_All_KPIs_${(/* @__PURE__ */ new Date()).toISOString().slice(0, 10)}.xlsx`);
}
...
function BulkExcelImportDialog({
  ...
  return /* @__PURE__ */ jsx(Dialog, { open, onOpenChange: handleClose, children: /* @__PURE__ */ jsxs(DialogContent, { className: "max-w-lg", children: [
    /* @__PURE__ */ jsxs(DialogHeader, { children: [
      /* @__PURE__ */ jsx(DialogTitle, { children: "Bulk import KPI templates" }),
      /* @__PURE__ */ jsx(DialogDescription, { children: "Upload an Excel file containing multiple department and role templates." })
    ] }),
    /* @__PURE__ */ jsx(
      "input",
      {
    ...
    /* @__PURE__ */ jsxs(
      Button,
      {
        ...
        className: "gap-2",
        children: [
          parsing ? /* @__PURE__ */ jsx(Loader2, { className: "h-4 w-4 animate-spin" }) : /* @__PURE__ */ jsx(Upload, { className: "h-4 w-4" }),
          fileName || "Choose Excel file"
        ]
      }
    ),
    errors.length > 0 && /* @__PURE__ */ jsx("div", { className: "text-sm text-red-600 space-y-1", children: errors.slice(0, 10).map((error, index) => /* @__PURE__ */ jsx("div", { children: error }, index)) }),
    templates.length > 0 && /* @__PURE__ */ jsxs("div", { className: "text-sm text-muted-foreground", children: [
      "Parsed ",
      templates.length,
      " template",
    ...
    /* @__PURE__ */ jsxs(DialogFooter, { children: [
      /* @__PURE__ */ jsx(Button, { variant: "outline", onClick: () => handleClose(false), children: "Cancel" }),
...
function KPIFrameworkPage() {
  ...
  const [pushAllPreview, setPushAllPreview] = useState(null);
  ...
  return /* @__PURE__ */ jsxs(motion.div, { initial: "hidden", animate: "show", variants: staggerContainer, className: "space-y-6", children: [
    /* @__PURE__ */ jsx(PageHeader, { title: isSingleMode ? `Editing: ${selectedDept} / ${selectedRole}` : "KPI Framework", description: isSingleMode ? "Edit the template below, then save and push to employees." : "Bulk operations across every department and role. Pick a specific template below to edit it.", icon: /* @__PURE__ */ jsx(FileSpreadsheet, { className: "h-6 w-6" }), actions: /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-2 flex-wrap", children: [
      /* @__PURE__ */ jsxs(Button, { variant: "outline", size: "sm", onClick: handleExport, className: "gap-2", children: [
        /* @__PURE__ */ jsx(Download, { className: "h-3.5 w-3.5" }),
        isSingleMode ? "Export Template" : "Export All"
      ] }),
      /* @__PURE__ */ jsxs(Button, { variant: "outline", size: "sm", onClick: handleImportClick, className: "gap-2", children: [
        /* @__PURE__ */ jsx(Upload, { className: "h-3.5 w-3.5" }),
        isSingleMode ? "Import Template" : "Bulk Import"
      ] }),
      isSingleMode && template && /* @__PURE__ */ jsxs(Button, { variant: "outline", size: "sm", onClick: handleSave, className: "gap-2", children: [
        /* @__PURE__ */ jsx(Save, { className: "h-3.5 w-3.5" }),
        " Save"
      ] }),
      /* @__PURE__ */ jsxs(Button, { size: "sm", onClick: handlePushClick, disabled: isSingleMode && (pushing || totalWeight !== 100) || !isSingleMode && pushingAll, className: "gap-2 bg-gradient-to-r from-blue-600 to-blue-500 hover:from-blue-700 hover:to-blue-600 text-white shadow-md shadow-blue-500/20 disabled:opacity-50", children: [
    ...
    /* @__PURE__ */ jsx(motion.div, { variants: fadeUp, children: /* @__PURE__ */ jsx(Card, { className: "p-5", children: /* @__PURE__ */ jsxs("div", { className: "grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4", children: [
      /* @__PURE__ */ jsxs("div", { children: [
        ...
        /* @__PURE__ */ jsxs(Select, { value: selectedDept, onValueChange: (v) => {
          setSelectedDept(v);
          setSelectedRole("");
        }, children: [
          /* @__PURE__ */ jsx(SelectTrigger, { className: "h-10", children: /* @__PURE__ */ jsx(SelectValue, { placeholder: "Select department (or leave empty for bulk)" }) }),
      ...
      /* @__PURE__ */ jsxs("div", { children: [
        /* @__PURE__ */ jsx(Label, { className: "text-xs text-muted-foreground mb-1.5", children: isSingleMode ? "Template Status" : "Mode" }),
        /* @__PURE__ */ jsx("div", { className: "flex items-center gap-2 h-10 px-3 rounded-md border border-border bg-muted/30 text-sm", children: isSingleMode && template ? /* @__PURE__ */ jsxs(Fragment, { children: [
        ...
        ] }) : /* @__PURE__ */ jsx("span", { className: "text-[11px] text-muted-foreground", children: "Bulk mode — actions affect every template" }) }),
        isSingleMode && /* @__PURE__ */ jsx("button", { onClick: () => {
          setSelectedDept("");
          setSelectedRole("");
        }, className: "text-[10px] text-muted-foreground hover:text-foreground mt-1.5 underline", children: "← Back to bulk view" })
      ] })
    ] }) }) }),
    isSingleMode && template ? /* @__PURE__ */ jsxs("div", { className: "space-y-4", children: [
      ...
      template.categories.length > 0 && /* @__PURE__ */ jsx(motion.div, { variants: fadeUp, children: /* @__PURE__ */ jsxs(Card, { className: "p-4 flex flex-wrap items-center justify-between gap-3 bg-muted/30", children: [
        ...
        /* @__PURE__ */ jsxs("div", { className: "flex gap-2", children: [
          ...
          /* @__PURE__ */ jsxs(Button, { size: "sm", onClick: handlePushClick, disabled: pushing || totalWeight !== 100, className: "gap-2 bg-gradient-to-r from-blue-600 to-blue-500 hover:from-blue-700 hover:to-blue-600 text-white shadow-md shadow-blue-500/20 disabled:opacity-50", children: [
            /* @__PURE__ */ jsx(Send, { className: "h-3.5 w-3.5" }),
            "Push to Employees"
          ] })
        ] })
      ] }) })
    ] }) : /* @__PURE__ */ jsx(motion.div, { variants: fadeUp, children: /* @__PURE__ */ jsx(Card, { children: /* @__PURE__ */ jsx(EmptyState, { icon: /* @__PURE__ */ jsx(FileSpreadsheet, { className: "h-6 w-6" }), title: isSingleMode ? "Loading template…" : "Bulk mode", description: isSingleMode ? "Loading the KPI template for this department and role." : "Use the buttons above to export, import, or push all templates at once. Or pick a specific department and role to edit it." }) }) }),
    /* @__PURE__ */ jsx(Dialog, { open: pushDialogOpen, onOpenChange: setPushDialogOpen, children: /* @__PURE__ */ jsxs(DialogContent, { className: "max-w-2xl max-h-[85vh] flex flex-col p-5", children: [
      ...
      /* @__PURE__ */ jsxs(DialogFooter, { className: "flex-row justify-end gap-2 pt-3 border-t", children: [
        ...
        /* @__PURE__ */ jsx(Button, { size: "sm", onClick: confirmPushSingle, disabled: pushing, className: "gap-2 bg-gradient-to-r from-blue-600 to-blue-500 hover:from-blue-700 hover:to-blue-600 text-white", children: pushing ? /* @__PURE__ */ jsxs(Fragment, { children: [
    ...
    /* @__PURE__ */ jsx(Dialog, { open: pushAllDialogOpen, onOpenChange: setPushAllDialogOpen, children: /* @__PURE__ */ jsxs(DialogContent, { className: "max-w-2xl max-h-[85vh] flex flex-col p-5", children: [
      /* @__PURE__ */ jsxs(DialogHeader, { className: "space-y-1.5", children: [
        /* @__PURE__ */ jsxs(DialogTitle, { className: "flex items-center gap-2 text-base", children: [
          /* @__PURE__ */ jsx(Send, { className: "h-4 w-4 text-primary" }),
          "Push all KPI changes to every employee?"
        ] }),
        /* @__PURE__ */ jsx(DialogDescription, { className: "text-[11px] leading-relaxed", children: pushAllPreview && /* @__PURE__ */ jsxs(Fragment, { children: [
          /* @__PURE__ */ jsx("strong", { className: "text-foreground", children: pushAllPreview.templateCount }),
          " template",
          pushAllPreview.templateCount === 1 ? "" : "s",
          " will be pushed to",
          " ",
          /* @__PURE__ */ jsx("strong", { className: "text-foreground", children: pushAllPreview.affectedCount }),
          " employee",
          pushAllPreview.affectedCount === 1 ? "" : "s",
          " —",
          " ",
          /* @__PURE__ */ jsx("strong", { className: "text-foreground", children: pushAllPreview.totalChanges }),
          " total change",
      ...
      pushAllPreview && /* @__PURE__ */ jsx("div", { className: "flex-1 overflow-y-auto -mx-5 px-5 py-1 space-y-2", children: pushAllPreview.employees.map((emp) => /* @__PURE__ */ jsx(Card, { className: "p-3", children: /* @__PURE__ */ jsxs("div", { className: "flex items-center justify-between gap-3", children: [
        /* @__PURE__ */ jsxs("div", { className: "min-w-0", children: [
          /* @__PURE__ */ jsx("div", { className: "font-medium text-[13px] truncate", children: emp.name }),
      ...
      /* @__PURE__ */ jsxs(DialogFooter, { className: "flex-row justify-end gap-2 pt-3 border-t", children: [
        ...
        /* @__PURE__ */ jsx(Button, { size: "sm", onClick: confirmPushAll, disabled: pushingAll, className: "gap-2 bg-gradient-to-r from-blue-600 to-blue-500 hover:from-blue-700 hover:to-blue-600 text-white", children: pushingAll ? /* @__PURE__ */ jsxs(Fragment, { children: [
          /* @__PURE__ */ jsx(Loader2, { className: "h-3.5 w-3.5 animate-spin" }),
          "Pushing all…"
        ] }) : /* @__PURE__ */ jsxs(Fragment, { children: [
          /* @__PURE__ */ jsx(Send, { className: "h-3.5 w-3.5" }),
    ...
    /* @__PURE__ */ jsx(BulkExcelImportDialog, { open: bulkImportOpen, onOpenChange: setBulkImportOpen, onApply: handleBulkApply })
  ] });
}
