...
async function getStartManifest(matchedRoutes) {
  const { tsrStartManifest } = await import("./_tanstack-start-manifest_v-N1_T_yv2.js");
...
async function loadEntries() {
  const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
    import("./router-ykR6owpd.js").then((n) => n.r),
    import("./start-PP1l5-dK.js"),
...
var ROUTER_BASEPATH = "p4p-app-v2";
var SERVER_FN_BASE = "/p4p-app-v2/_serverFn/";
