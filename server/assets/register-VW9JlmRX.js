...
import { P as P4PProvider, u as useP4P, s as supabase, n as newId } from "./router-CQTT2apA.js";
import { r as register, l as login } from "./auth-Cy9a3duB.js";
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const newEmployee = {
        ...
        email,
        authUserId,
        // ← NEW: Supabase Auth user ID added here
        department,
        role,
