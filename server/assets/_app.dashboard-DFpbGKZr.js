...
import { a as useP4P, b as useUser, s as supabase, f as fmtGHS, c as fmtNum, g as getCurrentUser } from "./router-w7c543WJ.js";
...
import { f as fadeUp, s as staggerContainer, t as tabContent, c as cardHover } from "./motion-BS01Szpl.js";
import { AlertCircle, ArrowRight, CheckCircle2, UserX, Target, ClipboardCheck, Bell, ChevronRight, RefreshCw, Calendar, Sparkles, Save, Settings, DollarSign, Wallet, TrendingUp, Users, UserCheck, Activity, Award, AlertTriangle, BarChart3, PieChart, Zap, CheckCircle, Info, Star, Clock } from "lucide-react";
  ...
  return /* @__PURE__ */ jsxs(
    "button",
    {
      ...
      children: [
        ...
        /* @__PURE__ */ jsxs("div", { className: "flex-1 min-w-0 break-words", children: [
          /* @__PURE__ */ jsx("div", { className: "font-medium text-[13px]", children: "KPI updates need your attention" }),
          /* @__PURE__ */ jsxs("div", { className: "text-[11px] text-muted-foreground", children: [
            "HR made ",
            pending,
            " change",
            pending > 1 ? "s" : "",
            " to your KPIs. Review and acknowledge."
          ] })
        ] }),
...
function NeedsAttention() {
  ...
  if (totalIssues === 0) {
    return /* @__PURE__ */ jsx(
      motion.div,
      {
        ...
        animate: "show",
        variants: fadeUp,
        children: /* @__PURE__ */ jsx(Card, { className: "p-6 border-emerald-500/20 bg-emerald-500/5", children: /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-3", children: [
  ...
  return /* @__PURE__ */ jsxs(
    motion.div,
    {
      ...
      className: "space-y-3",
      children: [
        /* @__PURE__ */ jsxs(motion.div, { variants: fadeUp, className: "flex items-center gap-2", children: [
...
function Dashboard() {
  ...
  return /* @__PURE__ */ jsxs(motion.div, { initial: "hidden", animate: "show", variants: staggerContainer, className: "space-y-6", children: [
    ...
    /* @__PURE__ */ jsxs("div", { className: "grid grid-cols-2 md:grid-cols-4 gap-4", children: [
      ...
      /* @__PURE__ */ jsx(StatCard, { icon: /* @__PURE__ */ jsx(Wallet, { className: "h-4 w-4" }), label: "Est. Bonus", value: /* @__PURE__ */ jsx(AnimatedNumber, { value: estimatedBonus, decimals: 0, prefix: "GHS " }), sub: "Based on current performance", accent: "info" }),
