...
import { h as hoverLift, f as fadeUp } from "./motion-DlChdgW6.mjs";
import { m as motion } from "../_libs/framer-motion.mjs";
import { ax as ArrowUpRight, ay as ArrowDownRight } from "../_libs/lucide-react.mjs";
const ACCENT_STYLES = {
...
function StatCard({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(motion.div, { variants: fadeUp, ...hoverLift, className: "h-full", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
    Card,
    {
      ...
      children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative flex items-start justify-between gap-3 mb-3", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-[11px] font-semibold text-muted-foreground uppercase tracking-wider truncate", children: label }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "div",
            {
        ...
        (sub || trend !== void 0) && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative flex items-center gap-1 mt-2 text-xs text-muted-foreground", children: [
          ...
          sub && /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "truncate", children: sub })
        ] })
      ]
    }
  ) });
