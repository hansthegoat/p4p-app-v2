...
const INTEGRATION_NAME$3 = "FunctionToString";
...
const INTEGRATION_NAME$2 = "EventFilters";
...
export {
  consoleSandbox as $,
  addConsoleInstrumentationHandler as A,
  addFetchInstrumentationHandler as B,
  Client as C,
  addBreadcrumb as D,
  getEventDescription as E,
  debug as F,
  GLOBAL_OBJ as G,
  getComponentName as H,
  safeJoin as I,
  severityLevelFromString as J,
  parseUrl as K,
  getBreadcrumbLogLevelFromHttpStatusCode as L,
  fill as M,
  getFunctionName as N,
  startSession as O,
  getIsolationScope as P,
  captureSession as Q,
  safeSetSpanJSONAttributes as R,
  addGlobalErrorInstrumentationHandler as S,
  addGlobalUnhandledRejectionInstrumentationHandler as T,
  UNKNOWN_FUNCTION as U,
  captureEvent as V,
  isPrimitive as W,
  isString as X,
  stripDataUrlContent as Y,
  applyAggregateErrorsToEvent as Z,
  _enhanceErrorWithSentryInfo as _,
  addNonEnumerableProperty as a,
  getIntegrationsToSetup as a0,
  stackParserFromStackParserOptions as a1,
  initAndBind as a2,
  inboundFiltersIntegration as a3,
  functionToStringIntegration as a4,
  conversationIdIntegration as a5,
  dedupeIntegration as a6,
  setNormalizeStringifier as a7,
  addHandler as a8,
  maybeInstrument as a9,
  triggerHandlers as aa,
  uuid4 as ab,
  supportsHistory as ac,
  isNativeFunction as ad,
  timestampInSeconds as ae,
  setContext as af,
  getLocationHref as b,
  addExceptionTypeValue as c,
  addExceptionMechanism as d,
  captureException as e,
  isDOMError as f,
  getOriginalFunction as g,
  isDOMException as h,
  isErrorEvent$1 as i,
  isError as j,
  isPlainObject as k,
  isEvent as l,
  markFunctionWrapped as m,
  isParameterizedString as n,
  getClient as o,
  normalizeToSize as p,
  extractExceptionKeysForMessage as q,
  resolvedSyncPromise as r,
  applySdkMetadata as s,
  addAutoIpAddressToSession as t,
  getSDKSource as u,
  createTransport as v,
  withScope as w,
  makePromiseBuffer as x,
  createStackParser as y,
  defineIntegration as z
};
